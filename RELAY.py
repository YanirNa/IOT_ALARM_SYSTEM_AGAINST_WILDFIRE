...
class Mqtt_client():
    ...
    def on_message(self, client, userdata, msg):
        ...
        tempeture = float(m_decode.split('Temperature: ')[1].split(' Humidity: ')[0]) #Temp
        humidity = float(m_decode.split('Temperature: ')[1].split(' Humidity: ')[1])  #Hum
        if(tempeture > 85 and humidity < 5):
          self.publish_to("pr/home/5976397/sts", 'FIRE ALERT!')

    # MUST REMEMBER WHICH TOPIC APPEAR ON DHT
